...
class _ImagePickerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is AssetPickResult) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
...
class ImagePickerApi {
  ...
  Future<AssetPickResult?> pickImage(SourceSpecification source, MaxSize maxSize, int? imageQuality, bool requestFullMetadata) async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as AssetPickResult?);
    }
  }

  Future<List<AssetPickResult?>> pickMultiImage(MaxSize maxSize, int? imageQuality, bool requestFullMetadata, int? limit) async {
  ...
  Future<List<AssetPickResult?>> pickMedia(MediaSelectionOptions mediaSelectionOptions) async {
