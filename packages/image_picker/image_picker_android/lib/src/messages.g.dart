...
class AssetPickResult {
  ...
  static AssetPickResult decode(Object result) {
    result as List<Object?>;
...
class _ImagePickerApiCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return AssetPickResult.decode(readValue(buffer)!);
      case 129: 
...
class ImagePickerApi {
  ...
  /// Elements must not be null, by convention. See
  /// https://github.com/flutter/flutter/issues/97848
  Future<List<AssetPickResult?>> pickImages(SourceSpecification source, ImageSelectionOptions options, GeneralOptions generalOptions) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.image_picker_android.ImagePickerApi.pickImages';
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[source, options, generalOptions]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<AssetPickResult?>();
    }
  }
  ...
  /// Elements must not be null, by convention. See
  /// https://github.com/flutter/flutter/issues/97848
  Future<List<AssetPickResult?>> pickVideos(SourceSpecification source, VideoSelectionOptions options, GeneralOptions generalOptions) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.image_picker_android.ImagePickerApi.pickVideos';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  /// Elements must not be null, by convention. See
  /// https://github.com/flutter/flutter/issues/97848
  Future<List<AssetPickResult?>> pickMedia(MediaSelectionOptions mediaSelectionOptions, GeneralOptions generalOptions) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.image_picker_android.ImagePickerApi.pickMedia';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[mediaSelectionOptions, generalOptions]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<CacheRetrievalResult?> retrieveLostResults() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.image_picker_android.ImagePickerApi.retrieveLostResults';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
