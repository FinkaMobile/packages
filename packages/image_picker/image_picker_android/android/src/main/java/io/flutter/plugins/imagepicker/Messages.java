...
public class Messages {
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class AssetPickResult {
    ...
    private @Nullable String localIdentifier;

    public @Nullable String getLocalIdentifier() {
      return localIdentifier;
    }

    public void setLocalIdentifier(@Nullable String setterArg) {
      this.localIdentifier = setterArg;
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setLocalIdentifier(@Nullable String setterArg) {
        this.localIdentifier = setterArg;
        return this;
      }

      public @NonNull AssetPickResult build() {
        AssetPickResult pigeonReturn = new AssetPickResult();
        pigeonReturn.setPath(path);
        pigeonReturn.setLocalIdentifier(localIdentifier);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(localIdentifier);
      return toListResult;
    }

    static @NonNull AssetPickResult fromList(@NonNull ArrayList<Object> list) {
      AssetPickResult pigeonResult = new AssetPickResult();
      Object path = list.get(0);
      pigeonResult.setPath((String) path);
      Object localIdentifier = list.get(1);
      pigeonResult.setLocalIdentifier((String) localIdentifier);
      return pigeonResult;
    }
  }
  ...
  private static class ImagePickerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte) 128:
          return AssetPickResult.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 129:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof AssetPickResult) {
        stream.write(128);
        writeValue(stream, ((AssetPickResult) value).toList());
  ...
  public interface ImagePickerApi {
     ...
     * https://github.com/flutter/flutter/issues/97848
     */
    void pickImages(@NonNull SourceSpecification source, @NonNull ImageSelectionOptions options, @NonNull GeneralOptions generalOptions, @NonNull Result<List<AssetPickResult>> result);
    /**
     ...
     * https://github.com/flutter/flutter/issues/97848
     */
    void pickVideos(@NonNull SourceSpecification source, @NonNull VideoSelectionOptions options, @NonNull GeneralOptions generalOptions, @NonNull Result<List<AssetPickResult>> result);
    /**
     ...
     * https://github.com/flutter/flutter/issues/97848
     */
    void pickMedia(@NonNull MediaSelectionOptions mediaSelectionOptions, @NonNull GeneralOptions generalOptions, @NonNull Result<List<AssetPickResult>> result);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                Result<List<AssetPickResult>> resultCallback =
                    new Result<List<AssetPickResult>>() {
                      public void success(List<AssetPickResult> result) {
